...
class MenuTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Menu::create(['restaurant_id' => '2','name' => 'Pepsi 2 Litre Bottle','description' => 'The bold, robust, effervescently magic cola.','image' => 'uploads/menu/2/41e7b17d-84c6-4812-b685-a1e3029a35c5.png','category_id' => 30,'price' => 3.49]);
        Menu::create(['restaurant_id' => '2','name' => 'The Ultimate Hershey\'s Chipits Cookie','description' => 'Freshly baked. Served warm and gooey. Try it today!','image' => 'uploads/menu/2/99e8bbfd-fb49-412b-a9f7-5ac60183fa5f.png','category_id' => 5,'price' => 6.99]);
        Menu::create(['restaurant_id' => '2','name' => 'Creamy Chicken Alfredo','description' => 'Sliced grilled chicken breast tossed with oven-baked rotini in a creamy alfredo sauce. Includes fresh breadsticks.','image' => 'uploads/menu/2/6050d919-cef9-4c61-bb97-bd8468094ffc.png','category_id' => 17,'price' => 16.99]);
        ...
        Menu::create(['restaurant_id' => '3','name' => '25 PIECE PARTY PACK','description' => '25 pieces of our Canadian farm raised and hand-breaded Secret Recipe chicken, 2 large golden fries, large gravy and 3 large homestyle sides of your choice. A feast fit for the hungriest of friends and family.','image' => 'uploads/menu/3/25_Bucket_Feast.jpeg','category_id' => 9,'price' => 38.99]);
        Menu::create(['restaurant_id' => '3','name' => 'SANDWICH BUCKET','description' => '2 Double Tender sandwiches and 2 choices of Big Crunch or Zinger sandwiches served with large fries.','image' => 'uploads/menu/3/sandwich_bucket_newfmi.jpeg','category_id' => 19,'price' => 26.99]);
        Menu::create(['restaurant_id' => '3','name' => 'GO BUCKET - KENTUCKY FLATBREAD','description' => 'Our flatbread filled with 1 white meat chicken tender hand-breaded in our 11 herds and spices, topped with lettuce and pepper mayo. Served with individual fries. Good to go!','image' => 'uploads/menu/3/GB_K_FlatBread.jpeg','category_id' => 29,'price' => 3.49]);
        Menu::create(['restaurant_id' => '3','name' => 'SMALL POPCORN CHICKEN','description' => 'Bite-sized chicken. Big on flavour.','image' => 'uploads/menu/3/s_pop_chk.jpeg','category_id' => 29,'price' => 5.99]);
        ...
        Menu::create(['restaurant_id' => '7','name' => 'BACON & CHEESE WHOPPER','description' => 'Our Bacon and Cheese WHOPPER® Sandwich is a ¼ lb of savory flame-grilled beef topped with thick-cut smoked bacon, melted cheese, ripe tomatoes, fresh lettuce, creamy mayonnaise, ketchup, crunchy pickles, and sliced onions, all on a warm, toasted, sesame seed bun.','image' => 'uploads/menu/7/03299-87 DIG_Silo_Bacon Cheese Whopper_500x540_CR.png','category_id' => 20,'price' => 8.99]);

        Menu::create(['restaurant_id' => '8','name' => 'SHAKES','description' => 'Chocolate, Strawberry or Vanilla made with real ice cream.','image' => 'uploads/menu/8/shakes.png','category_id' => 5,'price' => 4.49]);
        Menu::create(['restaurant_id' => '8','name' => 'BEVERAGES','description' => 'Refreshing selections include Coca-Cola, Diet Coke, 7UP, Dr. Pepper, Root Beer, Lemonade, Minute Maid Light Lemonade, Iced Tea, Milk, Coffee and Hot Cocoa.','image' => 'uploads/menu/8/cups.png','category_id' => 30,'price' => 2.19]);
        Menu::create(['restaurant_id' => '8','name' => 'FRENCH FRIES','description' => 'Fresh, hand-cut potatoes prepared in 100% sunflower oil.','image' => 'uploads/menu/8/fries.png','category_id' => 11,'price' => 3.89]);
